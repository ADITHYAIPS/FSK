...
Message Signal: Binary input signal to be modulated.
Carrier Signal (f1): Used for bit = 0.
Carrier Signal (f2): Used for bit = 1.
...
FSK modulation and demodulation were successfully demonstrated. The modulated signal varied between two frequencies depending on the binary input. The demodulated output correctly reproduced the original digital signal, validating the working of the FSK system. Attach the output waveform
